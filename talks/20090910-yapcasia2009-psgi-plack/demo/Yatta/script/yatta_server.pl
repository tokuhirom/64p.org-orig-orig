...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{YATTA_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{YATTA_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
yatta_server.pl - Catalyst Testserver

=head1 SYNOPSIS

yatta_server.pl [options]
